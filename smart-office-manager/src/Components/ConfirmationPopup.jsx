...
import "../resources/styles/ConfirmationPopup.scss";
        ...
        <div className="inner">
          <div className="card">
            <div className="container">
              ...
              <p>
                Management has been notified about this. The issue will be fixed
                as soon as possible. Thank you!
              </p>
              <div className="button return">Returning to dashboard...</div>
